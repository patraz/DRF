...
from posts.views import PostView, post_list, post_detail, PostMixinListView, PostListView, PostDetailView, PostDestroyView, OwnerDetailView, CommentDetailView
...
urlpatterns = [
    ...
    # path('api/posts/<int:pk>/', PostView.as_view(), name='post-list'),
